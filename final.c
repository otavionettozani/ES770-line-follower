...
#define SYSTEM_KI 0.
#define SYSTEM_KD 0.
#define PERCENTAGE_MAX_VELOCITY 0.4
...
void startMotor1(char direction, int percentageVelocity){
	...
	percentageVelocity = percentageVelocity*PERCENTAGE_MAX_VELOCITY*CORRECTION_MOTOR_1;
...
void startMotor2(char direction , int percentageVelocity){
	...
	percentageVelocity = percentageVelocity*PERCENTAGE_MAX_VELOCITY*CORRECTION_MOTOR_2;
	dutycycle = ((MAX_MOTOR_ON-MIN_MOTOR_ON)*percentageVelocity)/100 + MIN_MOTOR_ON;
...
float line=0;
float PID=0, integrative=0, lastValue=0, derivative=0;
